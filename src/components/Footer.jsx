      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-24 border-b border-white/10 pb-24">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <a href="mailto:hello@poomo.com" className="text-2xl md:text-4xl border-b border-white hover:text-primary hover:border-primary transition-colors pb-2 text-white">
              hello@poomo.com
            </a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div>
            <a href="#" className="text-2xl font-bold tracking-tighter uppercase mb-6 block text-white">Poomo.</a>
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              A creative digital agency focused on delivering premium web experiences for brands.
            </p>
          </div>

          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest mb-6 text-gray-500">Sitemap</h4>
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest mb-6 text-gray-500">Socials</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest mb-6 text-gray-500">Office</h4>
